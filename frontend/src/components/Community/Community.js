...
export default function Community({user, setUser}){
    return(
        <div className="community">
          ...
          <div className="container">
            <div className="communityContainer">
              ...
              <p className="communityAuthor"  style={{ textAlign: "left" }}>by Picasso</p>
        ...
        <div className="banner" style={{ backgroundImage: `url(${communityHero})`}}> /</div>

        <div className="forumposts">
          
            <div className="postImg"> 
                <img className="communityImg" src={homefeed1}alt=" home feed img 4"
            /></div>
            ...
            <div className="post">
              ...
              <p className="likeComments" style={{ textAlign: "left" }}>
                  {" "}
                    ...
                    <QuestionAnswerIcon style={{ fontSize: "15px", marginLeft:"10px" }} /> 44 likes{" "}
                  <span className="communityTime" style={{ float: "right", fontStyle:"italic",marginRight:"10px"}}>
                    6 hours ago{" "}
                  </span>
                </p>
